...
@section('content')
<div class="container" style="height: 100vh;margin-top: 80px;">
                ...
                <div class="card-body">
                    <form method="POST" action="/profile" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="current-password" type="password" class="form-control" name="cur_password" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="custom-file mb-3">
                                    <input type="file" class="custom-file-input" id="avatar" name="avatar_image" autocomplete="avatar">
                                    <label class="custom-file-label" for="customFile">Choose file</label>
                                </div>
                                <!-- <input id="avatar" type="file" class="form-control" name="avatar_image" autocomplete="avatar"> -->
                            </div>
                        </div>
